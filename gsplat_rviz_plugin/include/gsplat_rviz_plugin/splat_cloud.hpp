#ifndef GSPLAT_RVIZ_PLUGIN__SPLAT_CLOUD_HPP_
#define GSPLAT_RVIZ_PLUGIN__SPLAT_CLOUD_HPP_
...
class GSPLAT_RVIZ_PLUGIN_PUBLIC SplatCloud
...
#endif  // GSPLAT_RVIZ_PLUGIN__SPLAT_CLOUD_HPP_
